...
export const DEFAULT_CONFIG: PluginConfig = {
    ...
    dynamicMessageIncludeTitle: true,
    dynamicMessageIncludeContent: true,
    dynamicMessageIncludeType: true,
    dynamicMessageIncludeLink: true,
    dynamicMessageIncludeImage: true,
    cookie: '',
...
export function buildConfigSchema(ctx: NapCatPluginContext): PluginConfigSchema {
    return ctx.NapCatConfig.combine(
        ...
        ctx.NapCatConfig.boolean('dynamicMessageIncludeTitle', '动态消息包含标题', true, '推送动态时附带标题。', true),
        ctx.NapCatConfig.boolean('dynamicMessageIncludeContent', '动态消息包含内容', true, '推送动态时附带正文内容。', true),
        ctx.NapCatConfig.boolean('dynamicMessageIncludeType', '动态消息包含类型', true, '推送动态时附带类型说明。', true),
        ctx.NapCatConfig.boolean('dynamicMessageIncludeLink', '动态消息包含链接', true, '推送动态时附带动态链接。', true),
        ctx.NapCatConfig.boolean('dynamicMessageIncludeImage', '动态消息包含图片', true, '推送动态时附带首图或封面图。', true),
